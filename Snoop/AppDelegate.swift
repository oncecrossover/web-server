...
class AppDelegate: UIResponder, UIApplicationDelegate {
  ...
  func registerForPushNotifications(_ application: UIApplication) {
    ...
    let notificationSettings = UIUserNotificationSettings(
      types: [.badge, .sound, .alert], categories: [newsCategory])
  ...
  func application(_ application: UIApplication, didRegisterForRemoteNotificationsWithDeviceToken deviceToken: Data) {
    ...
    if let uid = UserDefaults.standard.string(forKey: "email") {
  ...
  lazy var applicationDocumentsDirectory: URL = {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "com.peep.Peep" in the application's documents Application Support directory.
  ...
  lazy var managedObjectModel: NSManagedObjectModel = {
    ...
    let modelURL = Bundle.main.url(forResource: "Peep", withExtension: "momd")!
