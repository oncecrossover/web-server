...
public class FollowFilterWebHandler extends AbastractWebHandler
implements WebHandler {
  private static final Logger LOG = LoggerFactory
      .getLogger(FollowFilterWebHandler.class);

  public FollowFilterWebHandler(
  ...
  private String getResultJson(
    ...
    final List<FollowEntry> list = FollowDBUtil.getFollowEntries(
        session,
        params,
        false);
