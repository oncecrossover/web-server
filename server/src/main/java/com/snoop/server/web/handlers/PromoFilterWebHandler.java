...
public class PromoFilterWebHandler extends AbastractWebHandler implements WebHandler {
  private static final Logger LOG = LoggerFactory
      .getLogger(PromoFilterWebHandler.class);

  public PromoFilterWebHandler(
  ...
  private String getResultJson(
    ...
    final List<PromoEntry> list = PromoDBUtil.getPromos(
        session,
        params,
        false);
