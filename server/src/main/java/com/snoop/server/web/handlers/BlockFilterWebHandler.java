...
public class BlockFilterWebHandler extends AbastractWebHandler
implements WebHandler {
  private static final Logger LOG = LoggerFactory
      .getLogger(BlockFilterWebHandler.class);

  public BlockFilterWebHandler(
  ...
  private String getResultJson(
    ...
    final List<BlockEntry> list = BlockDBUtil.getBlockEntries(
        session,
        params,
        false);
