...
import com.gibbon.peeq.db.model.Category;
import com.gibbon.peeq.db.util.CatMappingDBUtil;
import com.gibbon.peeq.db.util.CategoryDBUtil;
...
public class CategoryFilterWebHandler extends AbastractPeeqWebHandler
implements PeeqWebHandler {

  private static final Logger LOG = LoggerFactory
      .getLogger(CategoryFilterWebHandler.class);

  public CategoryFilterWebHandler(
  ...
  private String getResultJson(
    ...
    final List<Category> list = CategoryDBUtil.getCategories(
        session,
        params,
        false);
